...
Deployed Application (**required**): [Kudos Board Deployed Site](https://kudosboard-q5c1.onrender.com)
...
`<div style="position: relative; padding-bottom: 54.166666666666664%; height: 0;"><iframe src="https://www.loom.com/embed/8931f824e97740d4a9fe27e42e4e0890?sid=e9b369a2-9a93-46fa-b156-63ab18859ba8" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>`

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

Yes! The pet labs introduced backend and databases really well.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would try to make my dark mode UI look a bit better. I would also do commenting because I set up the comments in my database, but never added any routes.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I had a really hard time with deployment. 
